...
/**
 * @author chenwei
 * @version ApplicationListener, v2.0 2021/2/1 15:18
 **/
public class CustomApplicationListener implements ApplicationListener {

	/**
	 * org.springframework.context.ApplicationListener 准确的说，这个应该不算spring&springboot当中的一个扩展点，
	 * ApplicationListener可以监听某个事件的event，触发时机可以穿插在业务方法执行过程中，自定义某个业务事件。
